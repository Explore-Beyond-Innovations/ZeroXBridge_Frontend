...
const GlowingSvg: React.FC = () => {
  ...
  useEffect(() => {
    const sequence = async () => {
      await controls1.start({ opacity: [0.1, 1, 0.1], transition: { duration: 2, ease: "easeInOut" } })
      await controls2.start({ opacity: [0.2, 1, 0.2], transition: { duration: 2, ease: "easeInOut" } })
      await controls3.start({ opacity: [0.5, 1, 0.5], transition: { duration: 2, ease: "easeInOut" } })
      await controls4.start({ opacity: [1, 1, 1], transition: { duration: 2, ease: "easeInOut" } })
    }
