      ...
      <div className="relative z-10 pt-9">
        <div className="text-center max-w-[90%] md:max-w-[420px] mx-auto py-2">
          ...
          <p className="text-[13px] md:text-[15px] text-[#9E9E9E] font-inter font-[300] max-w-[340px] mx-auto animate-fade-in-delay">
            Stay updated with the latest news, updates, and guides from the
            ZeroXBridge.
          </p>
        </div>
                  ...
                  {featuredPosts.map((post, index) => (
                    ...
                    >
                      <div className="absolute top-2 left-2 z-10">
                        <span
                          className={`${post.tagColor} text-white text-[11px]  font-mono font-[600] px-3 py-1 rounded-full border-[#A26DFF] border-[0.5px] select-none transform group-hover:scale-110 transition-all duration-200`}
                        >
                          {post.tag}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-col justify-center px-3 md:px-4 py-3 md:py-4 flex-1">
                        ...
                        <div className="flex flex-col lg:flex-row  lg:items-center gap-2 flex-wrap">
                          ...
                          <a
                            href={post.link}
                            className="bg-white w-fit text-black text-xs font-semibold px-2 py-1 rounded-full shadow hover:bg-gray-100 transition-all duration-200 transform hover:scale-105 hover:shadow-lg hover:shadow-white/20"
                          >
                            Read More
                          </a>
                        </div>
