...
const LiveStats = () => {
  ...
  return (
    <section className="w-full px-8 md:px-[50px] lg:px-0 2xl:px-0 py-16 2xl:py-24 bg-[#0B0B0C] 2xl:max-w-[3359px] mx-auto">
      <div className="w-full lg:w-[97%] 2xl:w-[90%] mx-auto max-w-[3359px]">
        ...
        <div className="grid grid-cols-1 md:flex md:flex-row gap-3 2xl:gap-4  w-full items-center justify-center 2xl:justify-between 2xl:px-[2rem]">
          {/* Total Value Locked Card */}
          <div className='hover:bg-[url("/border1.svg")] bg-cover bg-no-repeat h-[180px] w-full md:w-[350px] lg:w-[405px] 2xl:w-[892px] 2xl:h-[463.19] px[6px] py-[4px] rounded-[16px] 2xl:rounded-[42px] flex items-center justify-center group'>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.1 }}
              viewport={{ once: true }}
              className="bg-[#141414] border border-[#1f1f1f] rounded-[16px] 2xl:rounded-[42px] px-4 py-3 2xl:px-8 2xl:py-8 flex flex-col justify-between h-[176px] w-[99%] md:w-[347px] lg:w-[400px] 2xl:w-[99.5%] 2xl:h-[458px] relative overflow-hidden"
            >
          ...
          <div className='hover:bg-[url("/border1.svg")] bg-cover bg-no-repeat h-[180px] w-full md:w-[350px] lg:w-[405px] 2xl:w-[892px] 2xl:h-[463.19] px[6px] py-[4px] rounded-[16px] 2xl:rounded-[42px] flex items-center justify-center group'>
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#141414] border border-[#1f1f1f] rounded-[16px] 2xl:rounded-[42px] px-4 py-3 2xl:px-8 2xl:py-8 flex flex-col justify-between h-[176px] w-[99%] md:w-[347px] lg:w-[400px] 2xl:w-[99.5%] 2xl:h-[458px] relative"
            >
              <h3 className="text-[15.72px] 2xl:text-[42.11px] font-normal text-gray-400">
                xZB Supply
              </h3>
          ...
          <motion.div className='hover:bg-[url("/border1.svg")] bg-cover bg-no-repeat w-full overflow-hidden h-[180px] md:w-[546px] 2xl:w-[1426.41px] 2xl:h-[463.19]   px[6px] py-[4px] rounded-[16px] 2xl:rounded-[42px] flex items-center justify-center'
          animate={controls}
          onHoverStart={() => {
            setIsHovered(true);
            controls.start({
          ...
          onHoverEnd={() => {
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#141414] rounded-[16px] 2xl:rounded-[42px] px-4 py-3 2xl:px-8 2xl:py-8 w-[99%] md:w-[542px] h-[176px]  2xl:w-[99.8%] 2xl:h-[458px]"
