    ...
    <section className="w-full bg-[#0A0A0A]">
      <div className="xl:h-[406px]" style={{
        ...
        <div className="w-full flex flex-col gap-4 py-12 my-10 px-[clamp(16px,5vw,80px)] 3xl:px-[18.75rem]">
          ...
          {/* TEAM SECTION */}
        <div className="w-full bg-[#0F0F0F] py-16 mb-6 px-[clamp(16px,5vw,80px)] 3xl:px-[18.75rem]">
          <GradientWrapper className="h-fit w-fit rounded-full">
              <AutoFadeTextWrapper
                as="p"
                className="font-mono text-sm font-[500] text-[#9C9C9D] py-1 px-2 rounded-full w-fit bg-[#19191A] uppercase "
              ...
              team.map((member, index) => (
                <div key={index} className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-3 pt-3">
                    ...
                    <p className="text-[16px] font-light text-[#9E9E9E]">{member.skill}</p>
                  </div>
                  <div>
                    <p className="text-[16px] font-light text-[#9E9E9E]">{member.role}</p>
                  </div>
